...
const Register = () => {
  ...
  //Render to login after register...
  const navigate = useNavigate();

  //Valdiation props use in toast...
  const toastOptions = {
  ...
  //Data of form store in this states...
  ...
  //Form handlechange event to manage states...
